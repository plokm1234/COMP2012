...
Book::Book(double regular_price, const string& title, const string& genre, const string& publisher, double discount) : Product(regular_price), title(title), genre(genre), publisher(publisher), discount(discount){}
Book::~Book() {
